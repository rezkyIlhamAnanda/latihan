...
import 'package:latihan_16_mei/PraUTSRezky/page/page_detail_berita.dart';
...
class _ListBeritaState extends State<ListBerita> {
  ...
  Future<List<Datum>?> getBerita() async{
    try{
      ...
      http.get(Uri.parse("http://192.168.158.29/edukasi_server2/getBerita.php"));
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network('http://192.168.158.29/edukasi_server2/gambar_berita/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )
                                ),
