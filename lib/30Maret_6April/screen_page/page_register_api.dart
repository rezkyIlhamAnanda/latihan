...
import 'package:latihan_16_mei/30Maret_6April/model/model_registar.dart';
...
class _PageRegisterApiState extends State<PageRegisterApi> {
  ...
  Future<ModelRegister?> registerAccount() async{
    ...
    try{
      ...
      http.Response response = await http.post(Uri.parse('http://192.168.100.137/beritaDb/register.php'),
          body: {
