...
import 'package:latihan_16_mei/maps_hospital/page_screen/page_rs.dart';
...
class _PageKabupatenState extends State<PageKabupaten> {
  ...
  Future<void> getKabupaten() async {
    ...
    try {
      final response = await http.get(Uri.parse("http://192.168.158.29/rumahsakitDB/getKabupaten.php"));
              ...
              itemBuilder: (context, index) {
                return Padding(
                  ...
                  child: Card(
                    ...
                    elevation: 5,
                    child: ListTile(
                      leading: Icon(Icons.location_city, color: Colors.pink, size: 40),
                      title: Text(
